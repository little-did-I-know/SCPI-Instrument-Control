...
MODEL_REGISTRY = {
    ...
    "SDS824X HD": ModelCapability(
        ...
        series="SDS800XHD",
        num_channels=4,
        max_sample_rate=1.0,  # 1 GSa/s
        memory_depth=100_000_000,  # 100 Mpts
        bandwidth_mhz=200,
    ...
    "SDS1104X-E": ModelCapability(
        ...
        num_channels=4,
        max_sample_rate=1.0,
        memory_depth=14_000_000,  # 14 Mpts
        bandwidth_mhz=100,
        has_math_channels=True,
        has_fft=True,
        has_protocol_decode=True,
    ...
    "SDS5104X": ModelCapability(
        ...
        series="SDS5000X",
        num_channels=4,
        max_sample_rate=5.0,  # 5 GSa/s
        memory_depth=250_000_000,  # 250 Mpts
        bandwidth_mhz=1000,  # 1 GHz
        has_math_channels=True,
        has_fft=True,
        has_protocol_decode=True,
...
def detect_model_from_idn(idn_string: str) -> ModelCapability:
    ...
    generic_capability = ModelCapability(
        ...
        max_sample_rate=1.0,
        memory_depth=10_000_000,  # Conservative default
        bandwidth_mhz=100,  # Conservative default
        has_math_channels=True,  # Most models support this
        has_fft=True,  # Most models support this
        has_protocol_decode=False,  # Conservative - don't assume
